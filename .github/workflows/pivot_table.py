...
pt_tx = pd.pivot_table(p_data,index=['干部类型'],columns=['退休标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
pt_tg = pd.pivot_table(p_data,index=['干部类型'],columns=['退岗标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
...
row_alter = ['总部正职', '总部副职', '总部助理', '二级总部正职', '二级总部副职', '二级总部助理', '分公司正职', '分公司副职', '分公司助理', '子公司正职', '子公司副职', '子公司助理', '总部二级部门经理', '分公司二级部门经理', '营业部正职', '营业部正职（卫星）', '营业部副职', '营业部助理', '合计']
pt_merge7 = pt_merge.reindex(row_alter)  #行索引排序（干部类型不含公司领导和非行政职务）
...
pt_tx2 = pd.pivot_table(p_data,index=['总部级干部类别'],columns=['退休标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
pt_tg2 = pd.pivot_table(p_data,index=['总部级干部类别'],columns=['退岗标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
...
pt_tx2.columns = pt_tx2.columns.droplevel(level=0)
pt_tg2.columns = pt_tg2.columns.droplevel(level=0)
del pt_zzmm2['All']
del pt_zgxl2['All']
del pt_nljg2['All']
del pt_tx2['All']
...
pt_merge2 = pd.merge(pt_merge2,pt_tx2,how='left',left_index=True,right_index=True)
pt_merge2 = pd.merge(pt_merge2,pt_tg2,how='left',left_index=True,right_index=True)
...
pt_tx3 = pd.pivot_table(p_data,index=['部门类别'],columns=['退休标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
pt_tg3 = pd.pivot_table(p_data,index=['部门类别'],columns=['退岗标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
...
pt_tx3.columns = pt_tx3.columns.droplevel(level=0)
pt_tg3.columns = pt_tg3.columns.droplevel(level=0)
del pt_zzmm3['All']
del pt_zgxl3['All']
del pt_nljg3['All']
del pt_tx3['All']
...
pt_merge3 = pd.merge(pt_merge3,pt_tx3,how='left',left_index=True,right_index=True)
pt_merge3 = pd.merge(pt_merge3,pt_tg3,how='left',left_index=True,right_index=True)
...
pt_tx6 = pd.pivot_table(p_data,index=['组织','一级部门'],columns=['退休标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
pt_tg6 = pd.pivot_table(p_data,index=['组织','一级部门'],columns=['退岗标识'],values=['工号'],aggfunc={'工号':'count'}, fill_value=0, margins=True)
...
pt_tx6.columns = pt_tx6.columns.droplevel(level=0)
pt_tg6.columns = pt_tg6.columns.droplevel(level=0)
del pt_zzmm6['All']
del pt_zgxl6['All']
del pt_nljg6['All']
del pt_tx6['All']
...
pt_merge6 = pd.merge(pt_merge6,pt_tx6,how='left',left_index=True,right_index=True)
pt_merge6 = pd.merge(pt_merge6,pt_tg6,how='left',left_index=True,right_index=True)
...
pt_merge7.to_excel(pt_output, sheet_name='按干部类型（统计口径）')
