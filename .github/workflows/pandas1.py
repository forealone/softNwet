...
'''
cadre_data = pd.read_excel(r'E:\1-统计\201911\raw\干部信息明细表（含分子公司）.xls',sheet_name='干部信息明细表')
'''
...
job2_y = cadre_data.loc[cadre_data[cadre_data['职务'].str.contains('董事副总经理|业务董事|挂职甘肃|总部副总经理级待遇')].index,['管理人员信息：职务']]
...
cadre_data.loc[cadre_data[cadre_data['职务比对']=='NaN'].index,['职务比对']] = '不同'
print('以下人员职务信息将以[管理人员信息：职务]为准： \n', cadre_data.loc[cadre_data[cadre_data['职务比对']=='不同'].index,['人员姓名','部门名称','职务','管理人员信息：职务']])
...
print('因个别干部人事关系在证券公司，但实际任职职务在子公司，需修改对应人员的组织、部门字段 \n')
...
input('按回车确认修改... \n')
insertrow1 = pd.DataFrame({'组织':['非一体化管控子公司'],'一级部门':['申万宏源（香港）有限公司'],'部门名称':['申万宏源（香港）有限公司'],'工号':['--'],'人员姓名':['贺添'],'性别':['男'],'职务':['副总经理'],'干部类型':['子公司副职'],'干部职级':['总部副总经理级'],'政治面貌':['群众'],'最高学历':['硕士研究生毕业'],'出生日期':['1980-05'],'年龄':['38'],'身份证号':[''],'职等':[''],'本岗位任职日期':['2018-12-14'],'现职级任职日期':['2018-12-14']})
...
cadre_data['部门类别'] = None
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('零售客户事业部|机构客户事业部|投资交易事业部|国际业务总部|资产管理事业部|固定收益交易总部|固定收益融资总部|场外市场总部|承销保荐|多元金融部|投资管理部|产业投资管理子公司')].index,['部门类别']] = '总部业务部门'
...
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('扶贫办公室|纪检监察室|党委办公室|党委巡视办公室|工会办公室|团委办公室')].index,['部门类别']] = '总部党群部门'
...
list_sorted4 = ['上海分公司','江苏分公司','杭州分公司','北京分公司','四川分公司','深圳分公司','湖北分公司','广东分公司','温州分公司','辽宁分公司','江西分公司','重庆分公司','厦门分公司','大连分公司','宁波分公司','广西分公司','湖南分公司','天津分公司','山东分公司','吉林分公司','安徽分公司','海南分公司','福建分公司','河南分公司','黑龙江分公司','贵州分公司','青岛分公司','陕西分公司','甘肃分公司','山西分公司','宁夏分公司','云南分公司','河北分公司','内蒙古分公司','上海自贸区分公司','沈阳分公司','成都分公司','兰州分公司','西部证券']
...
#分拆表6：非行政职务
cadre_data_p6 = cadre_data.iloc[cadre_data[cadre_data['干部类型'] =='非行政职务'].index,:].reset_index(drop=True)
...
#输出
'''
cadre_data.to_excel(r'E:\1-统计\201911\raw\干部信息明细表（编辑）.xlsx')
'''
