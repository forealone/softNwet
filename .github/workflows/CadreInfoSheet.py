...
print('李雪峰体现总部总经理级 \n')
input('按回车确认修改... \n')
cadre_data.loc[cadre_data[cadre_data['人员姓名']=='李雪峰'].index,['组织','一级部门','部门名称']] = ['申万宏源证券有限公司','公司领导','公司领导']

print('黄伟主职部门为甘肃分公司 \n')
input('按回车确认修改... \n')
cadre_data.loc[cadre_data[cadre_data['工号']=='360001'].index,['一级部门','部门名称']] = ['甘肃分公司','甘肃分公司']

print('房庆利暂时体现机构客户总部总经理 \n')
input('按回车确认修改... \n')
cadre_data.loc[cadre_data[cadre_data['人员姓名']=='房庆利'].index,['一级部门','部门名称']] = ['机构客户总部','机构客户总部']
...
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('零售客户事业部|财富管理事业部|机构客户事业部|机构客户总部|投资交易事业部|国际业务总部|资产管理事业部|固定收益交易总部|固定收益外汇商品事业部（FICC事业部）|固定收益销售交易总部|固定收益融资总部|场外市场总部|金融创新总部|证券投资总部|证券投资事业部|承销保荐|多元金融部|投资管理部|产业投资管理子公司')].index,['部门类别']] = '总部业务部门'
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('监事会办公室|办公室|计划财务管理总部|董事会办公室|法律合规总部|风险管理总部|内核评审总部|风险资产处置办公室|信息技术保障总部|信息技术开发总部|信息技术架构组|稽核审计总部|运营中心|托管中心|战略规划总部|战略客户总部|资金营运总部|其他|计划财务部|人力资源部|战略管理部|总经理办公室|稽核审计部|法务风控部|资产运营总部')].index,['部门类别']] = '总部职能部门'
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('扶贫办公室|纪检监察室|纪律检查室|党委办公室|党委巡视办公室|工会办公室|团委办公室|党委组织部/人力资源总部|党委巡察办公室|党建工作部|企业文化部|纪委')].index,['部门类别']] = '总部党群部门'
...
#拆分重组与排序 ——根据实际情况随时调整
list_sorted = ['储晓明','杨玉成','徐宜阳','黄昊','杨文清','冯戎','方荣义','张克均','阳昌云','朱敏杰','徐际国','任全胜','薛军','陈晓升','刘跃','谢晨','张剑','徐亮','何沙','车作斌']  #按实际情况修改
