...
print('夏涛体现申银万国投资有限公司总经理 \n')
input('按回车确认修改... \n')
cadre_data.loc[cadre_data[cadre_data['人员姓名']=='夏涛'].index,['组织','一级部门','部门名称']] = ['非一体化管控子公司','申银万国投资有限公司','申银万国投资有限公司']

print('吴华丕体现申万宏源新加坡私人有限公司董事、行政总裁（CEO） \n')
input('按回车确认修改... \n')
cadre_data.loc[cadre_data[cadre_data['人员姓名']=='吴华丕'].index,['组织','一级部门','部门名称']] = ['非一体化管控子公司','申万宏源新加坡私人有限公司','申万宏源新加坡私人有限公司']

print('陈晓升体现申万菱信基金管理有限公司党总支书记（临时） \n')
input('按回车确认修改... \n')
cadre_data.loc[cadre_data[cadre_data['人员姓名']=='陈晓升'].index,['组织','一级部门','部门名称']] = ['非一体化管控子公司','申万菱信基金管理有限公司','申万菱信基金管理有限公司']
...
#贺添和梁钧（年龄每年得手动修改一下）
print('香港公司贺添、梁钧是经过公司党委面试和任命的干部，但是信息在人力系统中没有，为其手动添加一条记录 \n')
input('按回车确认修改... \n')
...
insertrow2 = pd.DataFrame({'组织':['非一体化管控子公司'],'一级部门':['申万宏源（香港）有限公司'],'部门名称':['申万宏源（香港）有限公司'],'工号':['---'],'人员姓名':['梁钧'],'性别':['男'],'职务':['副总经理'],'干部类型':['子公司副职'],'干部职级':['总部副总经理级'],'政治面貌':['中共党员'],'最高学历':['硕士研究生毕业'],'出生日期':['1984-07'],'年龄':['36'],'身份证号':[''],'职等':[''],'本岗位任职日期':['2021-01-14'],'现职级任职日期':['2021-01-14']})

cadre_data = cadre_data.append(insertrow1,ignore_index=True,sort=False)
cadre_data = cadre_data.append(insertrow2,ignore_index=True,sort=False)
...
cadre_data.loc[cadre_data[((cadre_data['组织'].str.contains('分公司')) | (cadre_data['组织'] == '申万宏源西部证券有限公司')) & (cadre_data['干部类型'].str.contains('分公司正职|分公司副职|分公司助理')) & (~cadre_data['一级部门'].str.contains('营业部'))].index,['总部级干部类别']] = '分公司本部领导班子'
cadre_data.loc[cadre_data[((cadre_data['组织'].str.contains('分公司')) | (cadre_data['组织'] == '申万宏源西部证券有限公司')) & (cadre_data['干部类型'].str.contains('分公司二级部门经理')) & (~cadre_data['一级部门'].str.contains('营业部'))].index,['总部级干部类别']] = '分公司二级部门经理'
...
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('零售客户事业部|财富管理事业部|机构客户事业部|机构客户总部|投资交易事业部|国际业务总部|资产管理事业部|固定收益交易总部|固定收益外汇商品事业部（FICC事业部）|固定收益销售交易总部|固定收益融资总部|场外市场总部|金融创新总部|证券投资总部|证券投资事业部|证券金融总部|承销保荐|多元金融部|投资管理部|产业投资管理子公司')].index,['部门类别']] = '总部业务部门'
cadre_data.loc[cadre_data[cadre_data['一级部门'].str.contains('监事会办公室|办公室|计划财务管理总部|董事会办公室|法律合规总部|风险管理总部|内核评审总部|风险资产处置办公室|信息技术保障总部|信息技术开发总部|信息技术架构组|审计总部|运营中心|托管中心|战略规划总部|战略客户总部|资金营运总部|其他|计划财务部|人力资源部|战略管理部|总经理办公室|稽核审计部|法务风控部|资产运营总部|行政管理总部')].index,['部门类别']] = '总部职能部门'
...
cadre_data.loc[cadre_data[(cadre_data['人员姓名'].isin(['储晓明','杨玉成','黄昊','徐宜阳','方荣义','张克均'])) & (cadre_data['一级部门']=='公司领导')].index,['公司领导类别1']] = '集团和证券公司党委班子'
...
cadre_data.loc[cadre_data[(cadre_data['人员姓名'].isin(['杨玉成','方荣义','朱敏杰','薛军','张剑','李雪峰','房庆利'])) & (cadre_data['一级部门']=='公司领导')].index,['公司领导类别2']] = '证券公司经营班子'

#拆分重组与排序 ——根据实际情况随时调整
list_sorted = ['储晓明','杨玉成','徐宜阳','黄昊','杨文清','方荣义','张克均','朱敏杰','任全胜','薛军','张剑','李雪峰','房庆利','刘跃','徐亮','何沙','车作斌']  #按实际情况修改
...
list_sorted4 = ['上海分公司','江苏分公司','浙江分公司','杭州分公司','北京分公司','四川分公司','深圳分公司','湖北分公司','广东分公司','温州分公司','辽宁分公司','江西分公司','重庆分公司','厦门分公司','大连分公司','宁波分公司','广西分公司','湖南分公司','天津分公司','山东分公司','吉林分公司','安徽分公司','海南分公司','福建分公司','河南分公司','黑龙江分公司','贵州分公司','青岛分公司','陕西分公司','甘肃分公司','山西分公司','宁夏分公司','云南分公司','河北分公司','内蒙古分公司','上海自贸区分公司','沈阳分公司','成都分公司','兰州分公司','西部证券','上海第二分公司','苏州分公司','台州分公司','南通分公司']
list_sorted5 = ['李建中','尚恒','毛宗平','马龙官','陈晓升','刘郎','刘震','来肖贤']  #董事长排监事长和总经理前面，笨办法，根据实际情况随时调整
#分拆表1：公司领导
...
if num_cadre_total == count_cadre_total:
    print('应有集团和证券各级干部',num_cadre,'+',num_group_cadre,'+ 贺添、梁钧 =',num_cadre+num_group_cadre+2,'人')
